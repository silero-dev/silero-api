...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/xiaomi/mimo-tts)
...
> **Try it now:** [https://synexa.ai/explore/xiaomi/mimo-tts](https://synexa.ai/explore/xiaomi/mimo-tts) — the hosted model behind this client. New accounts get a free trial credit.
...
|---|---|---|---|
| [`xiaomi/mimo-tts`](https://synexa.ai/explore/xiaomi/mimo-tts) | text-to-audio | Xiaomi MiMo V2.5 text-to-speech. Speaks text with one of 9 built-in voices, clones a voice from a reference clip, or invents a new voice from a written description. | $0.02 |
| [`elevenlabs/tts`](https://synexa.ai/explore/elevenlabs/tts) | text-to-audio | ElevenLabs text to speech. Reads text aloud in one of 21 built-in voices, across 29 languages on the default model and up to 74 on Eleven v3. | $0.05 |
| [`openai/whisper-v3`](https://synexa.ai/explore/openai/whisper-v3) | speech-to-text | Whisper large v3 transcribes or translates speech from an audio file, in 99 languages. | $0.004 |
